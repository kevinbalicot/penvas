...
export default class CollisionChecker extends System {
    update() {
    ...
    getHitbox(entity) {
        return {
            id: entity.id,
            x: entity.components.collision.x + entity.components.body.x,
            y: entity.components.collision.y + entity.components.body.y,
