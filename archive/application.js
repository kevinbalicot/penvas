...
export class Application extends Drawer {
    ...
    constructor(options = {}) {
        ...
        document.addEventListener('keydown', (e) => {
            try {
                ...
                if (
                    this.currentLayer &&
                    this.currentLayer.constructor !== Object &&
                    this.currentLayer.onKeydown
                ) {
    ...
    render(dt) {
        try {
            ...
            if (
                ...
                this.currentLayer.render(dt, this);
            } else if (this.currentLayer && this.currentLayer.render) {
                this.currentLayer.render.call(this, dt, this);
            }
        } catch(e) {
            this.handleError(e);
        }
    ...
    changeLayer(name, data = null) {
        ...
        if (layer) {
            try {
                if (this.currentLayer && this.currentLayer.constructor !== Object && this.currentLayer.destroy) {
                    this.currentLayer.destroy();
                } else if (this.currentLayer && this.currentLayer.destroy) {
                    this.currentLayer.destroy.call(this, data);
                }
                ...
                if (this.currentLayer.constructor !== Object && this.currentLayer.create) {
                ...
                for (let prop in this.currentLayer) {
                    if (this.currentLayer[prop] instanceof Model) {
                        this.currentLayer[prop].parent = this;
                    }
                }
            } catch(e) {
                this.handleError(e);
